 ...
 */
data class JwInfo(val school:String = "",val name:String = "", val url:String = "", val system:String = Constants.JW_NORMAL, val author:String = "",val version:Int = 0,val systemChi:String = ""):BaseVm(){
    companion object{
