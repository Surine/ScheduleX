...
public class NormalWeekProvider extends CoreWidgetProvider {
    ...
    protected RemoteViews updateUi(Context context, AppWidgetManager appWidgetManager, int id) {
        ...
        remoteViews.setTextViewText(R.id.widget_day_class_subtitle, Prefs.getBoolean(Constants.NEXT_DAY_STATUS + id, false) ? getDateFormat(getDateBeforeOfAfter(getDate(yyyyMMdd), 1), "MM月dd E") : getDate("MM月dd E"));
        //配置
