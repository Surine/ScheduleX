package cn.surine.schedulex.app_widget.terminal_ui
...
class TerminalUiDailyProvider : CoreWidgetProvider() {

    //这里更新UI
    public override fun updateUi(context: Context, appWidgetManager: AppWidgetManager, appId: Int): RemoteViews {
        val remoteViews = WidgetUtil.getRoot(context, R.layout.widget_terminal_ui)
//        //标题配置
...
//        //点击打开主界面
        ...
        //配置列表
        WidgetUtil.addList(TerminalUiDailyService::class.java, context, appWidgetManager, remoteViews, R.id.listview, appId)
        return remoteViews
    }
}